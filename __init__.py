...
def create_app():
    ...
    app.config['GOLDEN_TICKETS_MAIL_SUBJECT_PREFIX'] = '[Golden Tickets] '
    app.config['GOLDEN_TICKETS_MAIL_SENDER'] = 'Golden Tickets Admin <tomelay@gmail.com>'
    app.config['GOLDEN_TICKETS_ADMIN'] = os.environ.get('GOLDEN_TICKETS_ADMIN')
    # end email stuff
    db.init_app(app) # Initialiaze sqlite database
    # login manager contains the code that lets your application and Flask-Login work together
